...
The pseudoscalar is given a proper lifetime of 100 mm, so the four objects emerge from two displaced vertices. The prompt reference is `hToAA_4tau_ma10`.

## Configuration

* Hard process: `HiggsSM:gg2H`, m_h = 125 GeV
* `25:addChannel -> 36 36`, all SM Higgs decays closed
* m_a = 10 GeV, `36:addChannel -> 15 -15`, **ctau = 100 mm**
...
apptainer exec --bind $simdir \
  ...
  sh $simdir/run.sh hToAA_4tau_ma10_ctau100mm <nevents> <seed> $simdir False
```
