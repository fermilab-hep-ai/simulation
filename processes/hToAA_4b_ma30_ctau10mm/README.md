...
The pseudoscalar is given a proper lifetime of 10 mm, so the four objects emerge from two displaced vertices. The prompt reference is `hToAA_4b_ma30`.

## Configuration

* Hard process: `HiggsSM:gg2H`, m_h = 125 GeV
* `25:addChannel -> 36 36`, all SM Higgs decays closed
* m_a = 30 GeV, `36:addChannel -> 5 -5`, **ctau = 10 mm**
...
apptainer exec --bind $simdir \
  ...
  sh $simdir/run.sh hToAA_4b_ma30_ctau10mm <nevents> <seed> $simdir False
```
