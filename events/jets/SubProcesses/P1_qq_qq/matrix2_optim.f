...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5))  !  count 5
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6))  !  count 5
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7))  !  count 6
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,8))  !  count 6
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO,FK_ZERO,W(1,9))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,4),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_11,AMP(3,1))
     ...
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1_0(W(1,8),W(1,6),W(1,12),GC_11,AMP(4,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,5),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,6),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,5),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 2
      CALL FFV1P1N_3(W(1,7), W(1,3), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,5/), 
     & (/13,16/),
     & TMP, W, AMP(1,2))
      CALL FFV1_0(W(1,7),W(1,4),W(1,14),GC_11,AMP(1,2))
      CALL FFV1_0(W(1,8),W(1,3),W(1,15),GC_11,AMP(6,2))
      CALL FFV1P1N_3(W(1,8), W(1,4), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/13,16/),
