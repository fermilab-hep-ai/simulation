...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_11,ZERO,FK_ZERO,W(1,10))  !  count 1
      CALL FFV1P0_3(W(1,6),W(1,1),GC_11,ZERO,FK_ZERO,W(1,11))  !  count 1
     ...
     & (/9,12/),
     & TMP, W, AMP(1,1))
      CALL FFV1_0(W(1,7),W(1,4),W(1,11),GC_11,AMP(5,1))
      CALL FFV1_0(W(1,8),W(1,3),W(1,10),GC_11,AMP(2,1))
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV1P0_3(W(1,5),W(1,4),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 1
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 2
      CALL FFV1P1N_3(W(1,7), W(1,1), GC_11, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/13,16/),
     & TMP, W, AMP(1,2))
      CALL FFV1_0(W(1,7),W(1,2),W(1,15),GC_11,AMP(3,2))
      CALL FFV1_0(W(1,8),W(1,1),W(1,14),GC_11,AMP(4,2))
      CALL FFV1P1N_3(W(1,8), W(1,2), GC_11, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/13,16/),
