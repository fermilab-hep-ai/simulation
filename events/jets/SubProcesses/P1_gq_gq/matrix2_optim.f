...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,12))  !  count 1
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,13))  !  count 1
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 1
      CALL FFV1_0(W(1,7),W(1,11),W(1,5),GC_11,AMP(4,2))
      CALL FFV1_0(W(1,7),W(1,12),W(1,6),GC_11,AMP(2,2))
      CALL FFV1_0(W(1,8),W(1,13),W(1,5),GC_11,AMP(3,2))
