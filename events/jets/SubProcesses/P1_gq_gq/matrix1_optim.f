...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7))  !  count 6
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8))  !  count 6
      ...
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 1
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 1
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 1
      CALL FFV1_0(W(1,15),W(1,7),W(1,5),GC_11,AMP(3,3))
      CALL FFV1_0(W(1,16),W(1,7),W(1,6),GC_11,AMP(1,3))
      CALL FFV1_0(W(1,17),W(1,8),W(1,5),GC_11,AMP(4,3))
