...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 5
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 5
      CALL OXXXXX(P(0,3),ZERO,+1,+1*IC(3),W(1,5))  !  count 6
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,6))  !  count 6
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,7))  !  count 6
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,8))  !  count 6
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10,ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,3),GC_10,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_0(W(1,7),W(1,6),W(1,9),GC_11,AMP(3,1))
      CALL FFV1_0(W(1,7),W(1,6),W(1,10),GC_11,AMP(1,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,9),GC_11,AMP(4,1))
      CALL FFV1_0(W(1,8),W(1,5),W(1,10),GC_11,AMP(2,1))  !  count 1
