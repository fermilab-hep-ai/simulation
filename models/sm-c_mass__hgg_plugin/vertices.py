...
V_12__1 = Vertex(name = 'V_12__1',
                 particles = [P.a, P.a, P.H],
                 color = ['1'],
                 lorentz = [L.VVS3],
                 couplings = {(0,0): C.GC_1__1})


V_13__1 = Vertex(name = 'V_13__1',
                 particles = [P.g, P.g, P.H],
                 color = ['Identity(1,2)'],
                 lorentz = [L.VVS3],
                 couplings = {(0,0): C.GC_13__1})


V_37__1 = Vertex(name = 'V_37__1',
                 particles = [P.g, P.g, P.h1],
                 color = ['Identity(1,2)'],
                 lorentz = [L.VVS1__1],
                 couplings = {(0,0): C.GC_16__1})


V_41__1 = Vertex(name = 'V_41__1',
                 particles = [P.g, P.g, P.g, P.H],
                 color = ['f(1,2,3)'],
                 lorentz = [L.VVVS2],
                 couplings = {(0,0): C.GC_14__1})


V_42__1 = Vertex(name = 'V_42__1',
                 particles = [P.g, P.g, P.g, P.g, P.H],
                 color = ['f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)'],
                 lorentz = [L.VVVVS1, L.VVVVS2, L.VVVVS3],
                 couplings = {(1,1): C.GC_15__1,(0,0): C.GC_15__1,(2,2): C.GC_15__1})


V_43__1 = Vertex(name = 'V_43__1',
                 particles = [P.g, P.g, P.g, P.h1],
                 color = ['f(1,2,3)'],
                 lorentz = [L.VVVS1],
                 couplings = {(0,0): C.GC_17__1})
