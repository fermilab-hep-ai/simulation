...
GC_1__1 = Coupling(name = 'GC_1__1',
                   value = '-(AH*complex(0,1))',
                   order = {'HIW': 1})


GC_13__1 = Coupling(name = 'GC_13__1',
                    value = '-(complex(0,1)*GH)',
                    order = {'HIG': 1})


GC_14__1 = Coupling(name = 'GC_14__1',
                    value = '-(G*GH)',
                    order = {'HIG': 1,'QCD': 1})


GC_15__1 = Coupling(name = 'GC_15__1',
                    value = 'complex(0,1)*G**2*GH',
                    order = {'HIG': 1,'QCD': 2})


GC_16__1 = Coupling(name = 'GC_16__1',
                    value = '(complex(0,1)*Gphi)/8.',
                    order = {'HIG': 1})


GC_17__1 = Coupling(name = 'GC_17__1',
                    value = '-(G*Gphi)',
                    order = {'HIG': 1,'QCD': 1})
